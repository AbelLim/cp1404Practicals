...
def run_tests():
    ...
    test_car_2 = Car()
    assert test_car_2.fuel == 0, "Car does not set default fuel correctly"

    test_car_3 = Car(fuel=10)
    assert test_car_3.fuel == 10, "Car does not set fuel correctly"
...
def make_sentence(phrase):
    ...
    'It is an ex parrot.'
    >>> make_sentence('This is a correct phrase.')
